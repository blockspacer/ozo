...
struct connection {
    ...
    connection(handle_type handle, OidMap oid_map, connection_mock* mock, error_context_type error_context, io_context* io)
    : handle_(std::move(handle)), oid_map_(oid_map), mock_(mock), error_context_(error_context), io_(io) {}
